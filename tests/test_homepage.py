...
class TestHomePage:
   ...
   def test_02_change_language_button_in_home_page(self):
      self.base_pages.home_page.open_home_page("https://www.next.co.il/")
   ...
   def test_03_saving_data_after_exit(self):
      self.base_pages.home_page.open_home_page("https://www.next.co.il/")
   ...
   def test_04_clicking_on_the_main_logo_to_connect_the_home_page(self):
      self.base_pages.home_page.open_home_page("https://www.next.co.il/")
