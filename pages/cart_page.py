...
class CartPage(BasePage):
    ...
    __SELECT_OPTION=".pdp-css-1lksmtn:nth-child(1)"
    __ADD_TO_BAG=".pdp-css-xwot90"
    __BAG=".header-wo12yk"
    ...
    def purchase_purchase_an_item_cart(self):
        self.page.goto("https://www.next.co.il/en/style/st711966/670540#670540")
        self.click(self.__CLICK_TOOLBAR)
        self.page.locator(".pdp-css-1lksmtn:nth-child(1)").click()
    ...
    def saved_items_after_exit(self):
        self.page.goto("https://www.next.co.il/en/style/st453300/d41274#d41274")
        self.page.locator(".pdp-css-xwot90").click()
